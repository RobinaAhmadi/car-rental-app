...
const mockCars: Car[] = [
    { id: '1', name: 'BMW 3 Series', type: 'Sedan',
        image: 'https://images.unsplash.com/photo-1710011115877-650f805ddd6f?auto=format&fit=crop&w=1200&q=60',
        rating: 4.8, location: 'Downtown',
        features: ['Automatic', 'GPS', 'AC', 'Bluetooth', 'Sunroof'], price: 89, isAvailable: true },
    { id: '2', name: 'Mercedes C-Class', type: 'Sedan',
        image: 'https://images.unsplash.com/photo-1731142582229-e0ee70302c02?auto=format&fit=crop&w=1200&q=60',
        rating: 4.7, location: 'Airport',
        features: ['Automatic', 'GPS', 'AC', 'Premium Sound'], price: 95, isAvailable: false },
    { id: '3', name: 'Audi A4', type: 'Sedan',
        image: 'https://images.unsplash.com/photo-1748215041506-2392c951fff2?auto=format&fit=crop&w=1200&q=60',
        rating: 4.6, location: 'Downtown',
        features: ['Automatic', 'GPS', 'AC'], price: 78, isAvailable: true },
    { id: '4', name: 'Tesla Model 3', type: 'Sedan',
        image: 'https://images.unsplash.com/photo-1653047256226-5abbfa82f1d7?auto=format&fit=crop&w=1200&q=60',
        rating: 4.9, location: 'Midtown',
        features: ['Electric', 'Autopilot', 'Supercharging', 'Premium Interior'], price: 120, isAvailable: true },
    { id: '5', name: 'Range Rover Evoque', type: 'SUV',
        image: 'https://images.unsplash.com/photo-1698413935252-04ed6377296d?auto=format&fit=crop&w=1200&q=60',
        rating: 4.5, location: 'Uptown',
        features: ['AWD', 'GPS', 'AC', 'Leather Seats', 'Panoramic Roof'], price: 150, isAvailable: true },
];
...
const CarCard: React.FC<CarCardProps> = ({ car, isFavorite, onToggleFavorite, onViewDetails }) => (
    <TouchableOpacity activeOpacity={0.9} onPress={() => onViewDetails(car.id)} style={styles.card}>
...
const CarCardPage: React.FC = () => {
                ...
                <TouchableOpacity
                    onPress={() => {
                        if (navigation.canGoBack()) {
                            ...
                            // ingen skærm bagved → gå til login
    ...
    const handleViewDetails = (carId: string) => {
        ...
        navigation.navigate('CarDetails', {
            car: { id: Number(car.id), make: car.name.split(' ')[0], model: car.name, year: 2024 },
        });
    };
